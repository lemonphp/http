...
class Request extends Message implements RequestInterface
{
    ...
    {
        $this->method = Util::normalizeHTTPMethod($method);
        $this->uri = $uri;
        $this->headers = $headers;
        $this->body = $body ?: new Body(fopen('php://temp', 'wb+'));
    }
    ...
    {
        $requestTarget = Util::normalizeRequestTarget($requestTarget);
        $clone = clone $this;
    ...
    {
        $method = Util::normalizeHTTPMethod($method);
        $clone = clone $this;
        $clone->method = $method;
    ...
    public function withUri(UriInterface $uri, $preserveHost = false)
    {
        ...
        if ($uri->getHost() !== '' && (!$preserveHost || $this->getHeader('Host') === [])) {
