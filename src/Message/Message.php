...
abstract class Message implements MessageInterface
{
    ...
    {
        $version = Util::normalizeHTTPVersion($version);
        $clone = clone $this;
    ...
    public function withAddedHeader($name, $value)
    {
        ...
        if (is_string($value)) {
            ...
            array_merge($clone->headers[$name], array_values($value));
        } else {
            throw new \InvalidArgumentException('Header value only accept string or array of string');
        }
